...
public static class Arithmetics
{
    ...
    public static T GetMinValue<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T>() {
        Type theKey = typeof(T);
    ...
    /// the type <typeparamref name="T" />.</remarks>
    public static T GetMaxValue<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T>() {
        Type theKey = typeof(T);
